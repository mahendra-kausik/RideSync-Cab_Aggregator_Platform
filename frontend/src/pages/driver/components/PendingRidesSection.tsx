...
// ride.estimatedDistance/estimatedDuration are the real OSRM road-route values computed
// once server-side at booking (RoutingService) - no per-card fetch needed, and nothing to
// flicker between a placeholder and a resolved value.
const RideDistance: React.FC<{ ride: Ride }> = ({ ride }) => (
  <>
    ...
    <div className="meta-item">
      ...
      <span className="meta-value">{Math.ceil(ride.estimatedDuration)} min</span>
    </div>
  </>
);
